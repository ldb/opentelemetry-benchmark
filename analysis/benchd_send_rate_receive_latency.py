...
# This script plots the rate of sending traces per second and the receive latency in ms
# X Axis: time
...
for line in fileinput.input():
    ...
    if statusCode == '0': # Started worker
        ...
        latencyR[seconds].append(int(receiveTS) - int(endSendTS))
...
ax.set_title("\"" + title + "\" Sending rate and receive latency")
...
ax2.set_ylabel("receive latency in ms")
...
fig.tight_layout()
#pyplot.show()
pyplot.savefig("benchd_"+title+"_send_rate_receive_latency.png")
